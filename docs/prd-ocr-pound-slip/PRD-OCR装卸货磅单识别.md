...
| 接口 | 方法 | 说明 |
|------|------|------|
| `/api/v1/weigh-tickets/upload` | POST | 上传影像，触发 OCR |
| `/api/v1/weigh-tickets/{id}/status` | GET | 轮询识别/校验状态 |
| `/api/v1/weigh-tickets/{id}/manual-entry` | PUT | OCR 超时后手动录入提交 |
| `/api/v1/weigh-tickets/{id}/submit` | PUT | 司机二次提交（确认/修改/重拍） |
| `/api/v1/weigh-tickets/review-queue` | GET | 人工审核队列 |
| `/api/v1/weigh-tickets/{id}/review` | PUT | 审核通过/修正/驳回 |
| `/api/v1/waybills/{id}/weigh-tickets` | GET | 运单关联磅单列表 |
